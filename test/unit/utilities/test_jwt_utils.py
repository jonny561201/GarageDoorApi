...
class TestJwt:
    ...
    def test_is_jwt_valid__should_succeed_using_secret_from_settings_to_encode_token(self, mock_settings):
        ...
        mock_settings.get_instance.return_value.get_settings.return_value = {'Development': True, 'DevJwtSecret': jwt_secret}
        jwt_body = {'fakeBody': 'valueValue'}
        jwt_token = 'Bearer ' + jwt.encode(jwt_body, jwt_secret, algorithm='HS256').decode('UTF-8')
