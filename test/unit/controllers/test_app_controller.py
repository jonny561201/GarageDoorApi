...
class TestLoginController:
    ...
    def test_get_login__should_call_validate_credentials_with_post_body(self, mock_token, mock_validate, mock_db, mock_extract):
    ...
    @patch('svc.controllers.app_controller.create_jwt_token')
    def test_get_login__should_call_extract_credentials(self, mock_token, mock_validate, mock_db, mock_extract):
        mock_extract.return_value = (self.USER, self.PWORD)
        get_login(self.JWT_TOKEN)
    ...
    @patch('svc.controllers.app_controller.create_jwt_token')
    def test_get_login__should_call_create_jwt_token(self, mock_token, mock_validate, mock_db, mock_extract):
        mock_extract.return_value = (self.USER, self.PWORD)
        get_login(self.JWT_TOKEN)
    ...
    @patch('svc.controllers.app_controller.create_jwt_token')
    def test_get_login__should_return_response_from_jwt_service(self, mock_token, mock_validate, mock_db, mock_extract):
        mock_extract.return_value = (self.USER, self.PWORD)
    ...
    def test_get_login__should_respond_with_jwt_token(self, mock_datetime, mock_validate, mock_db, mock_extract):
        mock_extract.return_value = (self.USER, self.PWORD)
    ...
    def test_save_user_preferences__should_validate_bearer_token(self, mock_jwt, mock_db, mock_creds):
        ...
        save_user_preferences(bearer_token, user_id)
