...
class TestLightRequest:
    ...
    def test_get_assigned_lights__should_call_to_get_api_key(self, mock_api, mock_map, mock_jwt, mock_set):
    ...
    def test_get_assigned_lights__should_use_settings_light_user_name_pass_when_dev(self, mock_api, mock_map, mock_jwt, mock_set):
    ...
    def test_get_assigned_lights__should_pass_api_key_to_get_light_groups(self, mock_api, mock_map, mock_jwt, mock_set):
        mock_api.get_light_api_key.return_value = self.API_KEY
        get_assigned_lights(self.BEARER_TOKEN)

        mock_api.get_light_groups.assert_called_with(self.API_KEY)

    def test_get_assigned_lights__should_map_response_from_light_group_api(self, mock_api, mock_map, mock_jwt, mock_set):
    ...
    def test_get_assigned_lights__should_map_response_from_group_state_api(self, mock_api, mock_map, mock_jwt, mock_set):
    ...
    def test_get_assigned_lights__should_return_response_from_mapper(self, mock_api, mock_map, mock_jwt, mock_set):
    ...
    def test_get_assigned_lights__should_call_to_get_light_group_state(self, mock_api, mock_map, mock_jwt, mock_set):
        light_groups = {'1': {}}
        mock_api.get_light_api_key.return_value = self.API_KEY
    ...
    def test_set_assigned_lights__should_call_is_jwt_valid(self, mock_api, mock_map, mock_jwt, mock_set):
    ...
    def test_set_assigned_lights__should_make_api_call_to_set_brightness_optionally(self, mock_api, mock_map, mock_jwt, mock_set):
        brightness = 255
